...
const (
	...
	defaultAgentName = "tapmond"
)

// AgentName stores the name of the software that is added as the first part of
// the user agent string. This defaults to the value "tapmond" when being run as
// a standalone component but can be overwritten by LiT for example when tapmond
